...
public class Constants {
    public static final String SELECT_USER_TYPE = "Select your user type";
    public static final String CUSTOMER = "c - Customer";
    public static final String LIBRARIAN = "l - Librarian";
    public static final String WELCOME_MESSAGE = "WELCOME TO LIBRARY APP";
